        ...
        <div class="main-wrap">
            ...
            <div class="user-comment">
                ...
                <div class="comment-main">
                    <form method="post" action="/server/myaccept/comment">
                        <div class="comment-list">
                            ...
                            <div class="item-title">
                                ...
                                <div class="item-info">
                                    <div class="info-little">
                                        <span>资源主：${orderUserDto.senderName}</span>
                                    </div>
                            ...
                            <div class="item-comment">
                                <textarea placeholder="请写下对此次租借的感受吧，对他人帮助很大哦！" name="content" required></textarea>
                            </div>
