            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        <span class="title">余额充值历史列表</span>
                        <div class="description">以下是余额充值历史列表.</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="datatable table table-striped" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <c:forEach items="${moneyAddDtoList}" var="item">
                                                <tr class="manager-bg input-lg">

                                                    <td class="manager-border2">${item.user.phone}</td>
                                                    <td class="manager-border2">${item.user.nickname}</td>
                                                    <td class="manager-border2">${item.moneyadd.addamount}￥</td>
                                                    <td class="manager-border2">${item.moneyadd.addtime}</td>
                                                    <td class="manager-border2">${item.moneyadd.gettime}</td>
                                                    <c:choose>
                                                        <c:when test="${item.moneyadd.gettime==null||item.moneyadd.gettime==''}">
                                                    ...
                                                    <td class="manager-border2"  style="font-size: 17px">
                                                        <a href="/money/pay/${item.moneyadd.id}/detail">
