        ...
        <div class="container-fluid">
            <div class="side-body">
                <div class="page-title">
                    <span class="title">账号${goldAddDto.user.phone}的充值申请信息</span>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-body">
                                                <ul class="list-group text-left">
                                                    <c:choose>
                                                        <c:when test="${goldAddDto.user.headicon==null||goldAddDto.user.headicon==''}">
                                                        ...
                                                        <c:otherwise>
                                                            <li class="list-group-item">
                                                                <img src="http://localhost:8083/resources/img/${goldAddDto.user.headicon}"
                                                                     width="70px" height="80px"></li>
                                                        </c:otherwise>
                                                    </c:choose>
                                                    <li class="list-group-item">昵称：${goldAddDto.user.nickname}</li>
