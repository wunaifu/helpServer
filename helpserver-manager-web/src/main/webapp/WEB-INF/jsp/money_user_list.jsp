            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        <span class="title">用户余额列表</span>
                        <div class="description">以下是用户的余额列表.</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="datatable table table-striped" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <th class="manager-border2">总余额</th>
                                            <th class="manager-border2">已充值余额</th>
                                            <th class="manager-border2">已提现余额</th>
                                        ...
                                        <tbody>
                                            <c:forEach items="${moneyUserDtoList}" var="item">
                                                <tr class="manager-bg input-lg">
                                                    ...
                                                    <td class="manager-border2">${item.money.amount}￥</td>
                                                    <td class="manager-border2">${item.money.payamount}￥</td>
                                                    <td class="manager-border2">${item.money.getamount}￥</td>
                                                    <td class="manager-border2">${item.money.time}</td>
