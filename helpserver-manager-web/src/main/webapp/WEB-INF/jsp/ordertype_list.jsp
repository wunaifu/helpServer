            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        ...
                        <div class="description">以下是所有的订单类型，您可以进行查看修改.</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="title"><a href="/ordertype/addjsp">添加订单类型</a></div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <table class="datatable table table-striped" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <th class="manager-border2">类型标志</th>
                                            ...
                                            <c:forEach items="${orderTypeList}" var="item" varStatus="status">
                                                <tr class="manager-bg input-lg">
                                                    ...
                                                    <td class="manager-border2"  style="font-size: 17px">
                                                        ...
                                                        <a href="/ordertype/del/${item.ordertypeid}"><span class="label label-danger">删除</span></a>
                                                    </td>
